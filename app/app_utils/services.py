...
def get_memory_service():
    """Process-wide memory service: Vertex AI Memory Bank instance."""
    ...
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID"):
        ...
        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-f642bd17f85e"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
    ...
    return VertexAiMemoryBankService(
        project="qwiklabs-gcp-01-f642bd17f85e",
        location="us-east1",
        agent_engine_id="8094166998059057152",
    )
